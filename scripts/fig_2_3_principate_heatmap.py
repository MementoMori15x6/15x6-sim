# figure_2.3_principate_heatmap.py
# Purpose: Generate heatmap for Principate phase (or whatever the script does)
# Part of The Board project – Political Thermodynamics
