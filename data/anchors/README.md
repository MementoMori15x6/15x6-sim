# Canonical Anchors — Triangulation & Comparison

Fixed, numeric-only CSV configurations (35 metrics, −10..+10 scale) derived from consensus scores in `../`.

Use these as reference points in `simulate.py` for:
...
|--------|-----|------|--------|-----------|----------------|-------------------|------------------------|
| USA_1789 *(enforced)* | 0.59 | −0.02 | ~0.001 | 10.0% | Mutualism/Competition | 150+ yrs (Low Parasitism) | Healthy baseline: balanced mutualism, strong G rows, minimal suppression cost |
...
- **Two distinct collapse paths to the same Rule-13 % / longevity:** low-Y exploitation sink (VOC late) vs. high-Y suppression trap (USSR).
