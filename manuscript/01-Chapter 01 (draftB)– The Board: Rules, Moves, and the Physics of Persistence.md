...
From evolutionary game theory (Maynard Smith 1982; Nowak 2006), three conditions constrain interactions:

Payoff asymmetry

Thermodynamic limits (no system extracts infinite gain without cost)

Evolutionarily stable strategy (ESS) criteria—no rare mutant can invade and overturn the equilibrium
...
The remaining logical permutations collapse under relabeling or violate stability constraints. These six align with generalized Lotka–Volterra dynamics: competition, predator–prey, and mutualism variants.
...
Most complex systems mix moves. Durable constitutions tend to bias toward mutualism and regulated competition while suppressing unchecked parasitism. Where parasitism outpaces detection and suppression, cooperative equilibria degrade toward system-wide competition.
...
Each rule is framed minimally, with its constraint logic and observable signal:

Harvest negative entropy
Failure to import free energy results in structural decay under the Second Law.
Signal: metabolic ceiling and throughput limits.

Replicate with heredity
Patterns not copied with sufficient fidelity disappear.
Signal: persistence fidelity thresholds.

Allow heritable variation
Perfect copying prevents adaptation under environmental shift.
Signal: adaptive bandwidth and shock resilience.

Enable differential persistence
Variants must out-replicate alternatives for selection to operate.
Signal: measurable selection efficiency.

Survive until replication
Carriers must persist long enough to reproduce.
Signal: baseline durability and friction.

Acquire and defend resources
Competitors appropriate unguarded resources.
Signal: scarcity vulnerability.

Achieve reproductive success (direct or inclusive)
Replication must scale beyond replacement.
Signal: demographic and expansion metrics.

Adapt to environmental change
Static strategies lose under dynamic conditions.
Signal: rigidity thresholds.

Maintain diversity
Monocultures amplify systemic fragility.
Signal: diversity sinks and resilience gradients.

Construct and colonize niches
Unoccupied gradients are eventually exploited.
Signal: expansion into adjacent possibility space.

Maintain boundaries
Without definitional integrity, systems dissipate.
Signal: identity coherence.

Detect and repair error
Unchecked error accumulation leads to catastrophic failure.
Signal: decay rates and modular repair capacity.

Detect and suppress cheaters
Without immune function, mutualism collapses toward parasitism.
Signal: parasitic load thresholds and fracture risk.

Scale hierarchically or modularly
Flat systems face coordination ceilings.
Signal: governance density versus scale.

Separate information storage from execution
Durable systems decouple pattern from machinery (e.g., germline vs. soma).
Signal: reset capacity and longevity curves.
...
Rules and interaction grammars remain abstract without measurement. The next chapter operationalizes the framework into metrics that map systems within bounded zones of stability, rigidity, and fracture.

If persistence is governed by structural constraints rather than historical accident, then foresight becomes a question of measurement, not prophecy.
