...
def compute_coordinates(vector, y_multiplier=2.5, x_extra_weight=1.0):
    ...
    # Specific Rule-13/Hierarchy boosts
    ...
    # Biological tune for negative G-means
...
try:
    ...
    dominance[:, 0] = 95  # The "Perfect Lattice" Mutualism
    dominance[12, 0] = 98 # Specific Rule 13 Mutualism
